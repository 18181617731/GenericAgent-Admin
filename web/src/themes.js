...
export const THEMES = Object.freeze([
  ...
  },
  {
    ...
    icon: Sunset,
    label: { zh: '\u6696\u8272', en: 'Warm' },
    description: { zh: '\u67d4\u548c\u3001\u4e13\u6ce8\u7684\u7eb8\u611f\u8272\u8c03', en: 'Soft, focused paper tones' },
    preview: ['#f4efe5', '#fffaf0', '#835b35'],
    antdAlgorithm: 'default',
    antdToken: { colorBgBase: '#fbfaf7', colorTextBase: '#171717', colorBorder: 'rgba(23, 23, 23, .10)' },
  },
  {
    id: 'dark',
    colorScheme: 'dark',
