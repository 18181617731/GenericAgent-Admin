...
export const SETUP_TEXT = {
  zh: {
    ...
    root: {
      ...
      existingPlaceholder: '例如 C:\\Users\\you\\Desktop\\code\\GenericAgent',
      validate: '验证并接管',
      or: '或',
      installLabel: '安装到父目录',
      installPlaceholder: '例如 C:\\Users\\you\\Desktop\\code（将在其下创建 GenericAgent）',
      install: '安装 GA',
      browse: '浏览…',
  ...
  en: {
    ...
    root: {
      ...
      existingPlaceholder: 'For example C:\\Users\\you\\Desktop\\code\\GenericAgent',
      validate: 'Validate and use',
      or: 'or',
      installLabel: 'Install into parent directory',
      installPlaceholder: 'For example C:\\Users\\you\\Desktop\\code (GenericAgent is created inside it)',
      install: 'Install GA',
      browse: 'Browse…',
