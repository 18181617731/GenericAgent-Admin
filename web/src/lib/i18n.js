export const I18N = {
  zh: {
    ...
    desc: { overview: '运行状态、GA Admin 版本与 GA 源代码更新。', chat: '对话体验相关的偏好设置。', instances: '管理隔离的 GA 运行目录、Python 解释器和默认实例。', notifications: '查看系统通知与后台运行提示。', files: '安全浏览 GA 根目录内文本文件，支持 tail 与搜索。', memory: '浏览工作区记忆与相关文件。', 'local-cmd': '在任意本机目录打开可交互的 Windows CMD 窗口。', tasks: '任务型服务、sche_tasks 定时任务、Goal/自主运行与报告。', channels: '桌面、TUI、Web、IM Bot 等前端入口。', autonomous: '自主待机驱动与自动化任务推进状态。', schedule: 'sche_tasks JSON 定时任务详情、编辑、创建与删除。', goals: '复用 GA Goal Mode SOP 与 reflect/goal_mode.py 的持续目标控制台。', models: '按服务商读取、预览和保存 GA mykey.py 中的模型配置。', settings: '语言、外观、路径与网络等基础偏好。', usage: '按模型、会话与日期统计的 token 用量。', logs: '进程状态与输出日志。' },
