export const emptyProfile = (idx = 0, protocol = 'native_oai') => ({ var_name: `${protocol}_config${idx + 1}`, type: protocol, name: '', model: '', apibase: '', apikey: '', stream: true, max_retries: 3, read_timeout: 300, reasoning_effort: '' })
