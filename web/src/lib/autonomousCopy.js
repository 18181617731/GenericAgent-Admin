const COPY = {
  zh: {
    ...
    reviewBasis: '系统依据', reviewDecision: '模型结论', reviewConfidence: '置信度', reviewModel: '审核模型', reviewReason: '审核原因', reviewNoAutoApproval: '未自动批准', reviewRetryScheduled: '重新审核时会再次尝试', reviewGate: '报告明确要求人工审批', reviewBlocked: '报告处于阻塞状态', reviewChangeUnconfirmed: '拟议源码变更尚未确认实施', reviewEvidenceMissing: '审批证据缺失或无法核验', reviewConservative: '暂时按保守规则保留为待审批',
