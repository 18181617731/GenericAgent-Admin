const COPY = {
  zh: {
    ...
    pending: '待处理', handled: '已处理', noPending: '当前没有待审批任务', noHandled: '还没有审批记录', noLedger: '未发现待批草案台账', handledProgressTitle: '处理进展', handledProgressIntro: '已处理记录按当前执行进展分类，便于确认任务是否排队、完成或缺少归档。', handledProgress: { queued: '已加入 TODO，等待执行', completed: '已完成并归档', report_missing: '已完成，但没有归档文件', failed: '执行失败', not_applicable: '已拒绝，不执行', unknown: '已处理，等待状态同步' },
  ...
  en: {
    ...
    pending: 'Pending', handled: 'Handled', noPending: 'No tasks are waiting for approval', noHandled: 'No approval decisions yet', noLedger: 'No pending-draft ledger was found', handledProgressTitle: 'Processing progress', handledProgressIntro: 'Handled records are grouped by execution progress so you can see what is queued, complete, or missing its archive.', handledProgress: { queued: 'Added to TODO; waiting to run', completed: 'Completed and archived', report_missing: 'Completed, but no archive file', failed: 'Execution failed', not_applicable: 'Rejected; not executed', unknown: 'Handled; waiting for status sync' },
