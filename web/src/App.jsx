...
export default function App() {
  ...
  const revealModels = async () => { try { const d = await api('/api/models/raw'); const m = {}; (d.profiles||[]).forEach(p => { if (p.var_name && p.api_key) m[p.var_name] = p.api_key }); setRevealedKeys(m) } catch(e){ setMsg(e.message) } }
