...
import { CheckCircle2, Cpu, Pencil, Plus, RefreshCw, Save, Server, Star, Trash2, X } from 'lucide-react'
...
const TEXT = {
  zh: {
    ...
    add: '\u65b0\u5efa\u5b9e\u4f8b', refresh: '\u5237\u65b0', loading: '\u6b63\u5728\u8bfb\u53d6\u5b9e\u4f8b\u2026', empty: '\u6682\u65e0 GA \u5b9e\u4f8b',
    ...
    loadFailed: '\u8bfb\u53d6\u5b9e\u4f8b\u5931\u8d25', saved: '\u5b9e\u4f8b\u5df2\u4fdd\u5b58', defaultSaved: '\u9ed8\u8ba4\u5b9e\u4f8b\u5df2\u66f4\u65b0', removed: '\u5b9e\u4f8b\u5df2\u5220\u9664',
  ...
  en: {
    ...
    add: 'Add instance', refresh: 'Refresh', loading: 'Loading instances\u2026', empty: 'No GA instances configured',
    ...
    loadFailed: 'Failed to load instances', saved: 'Instance saved', defaultSaved: 'Default instance updated', removed: 'Instance deleted',
...
export default function InstancesPage({ lang = 'zh' }) {
  ...
  return <section className="instances-page">
    <div className="instances-hero">
      ...
      <div className="instances-toolbar">
        ...
        <button type="button" className="primary" onClick={beginCreate} disabled={anyBusy}><Plus size={16}/>{copy.add}</button>
      </div>
    </div>
