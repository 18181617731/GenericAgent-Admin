...
describe('InstancesPage', () => {
  ...
  it('confirms creation and sends the dangerous confirmation header', async () => {
    ...
    expect(editor.querySelector('.instance-editor-heading .instance-editor-actions')).not.toBeNull()
    expect(editor.querySelector('.instance-editor-heading-mark')).toBeNull()
